...
/** Controlador principal de dades de l'aplicaci�.
...
public class CtrlData {
	...
	*/
	 ...
	 * @param filename Adre�a de l'arxiu a llegir.
	 ...
	 * @param filename Adre�a de l'arxiu a on escriure (si no existeix es crear�).
	 ...
	 * @param path Adre�a de la carpeta.
